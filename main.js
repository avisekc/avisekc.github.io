...
/* harmony import */ var _item_selection_item_selection_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./item-selection/item-selection.component */ "./src/app/item-selection/item-selection.component.ts");
/* harmony import */ var _header_header_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./header/header.component */ "./src/app/header/header.component.ts");
/* harmony import */ var _sub_header_sub_header_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./sub-header/sub-header.component */ "./src/app/sub-header/sub-header.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var appRoutes = [
    ...
    { path: 'main-menu', component: _main_menu_main_menu_component__WEBPACK_IMPORTED_MODULE_7__["MainMenuComponent"] },
    {
        path: 'item-selection/:menuId',
        component: _item_selection_item_selection_component__WEBPACK_IMPORTED_MODULE_8__["ItemSelectionComponent"]
    },
    { path: '',
        redirectTo: '/home',
        pathMatch: 'full'
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _item_selection_item_selection_component__WEBPACK_IMPORTED_MODULE_8__["ItemSelectionComponent"],
            ],
            imports: [
...
module.exports = "<mdb-navbar SideClass=\"navbar navbar-expand-lg navbar-dark indigo sticky-top\">\n    <mdb-navbar-brand>\n        <form class=\"form-inline\">\n            <span class=\"navbar-brand\" href=\"#\">{{title}}</span>\n        </form>\n    </mdb-navbar-brand>\n</mdb-navbar>"
...
module.exports = ".card.card-cascade.wider.reverse .card-body.card-body-cascade {\n    position: absolute;\n    bottom: -125px;\n    z-index: 3;\n    margin-top: -1rem;\n    border-radius: .25rem;\n    box-shadow: 0 5px 11px 0 rgba(0, 0, 0, .18), 0 4px 15px 0 rgba(0, 0, 0, .15);\n    margin-left: 4%;\n    margin-right: 4%;\n    background: #fff;\n}\n\n.margin-top-200 {\n    margin-top: 200px;\n}\n\n.login-btn {\n    margin: 50px auto;\n    text-align: right;\n}"
...
module.exports = "<app-header [parentPage]=parentPage [title]=title></app-header>\n\n<div class=\"container-fluid\">\n    <mdb-card cascade=\"true\" wider=\"true\" reverse=\"true\" class=\"my-4\">\n        <!--Card image-->\n        <div class=\"view view-cascade overlay waves-light\" mdbWavesEffect>\n            <mdb-card-img src=\"assets/images/green-plate-home.jpg\"></mdb-card-img>\n            <a>\n                <div class=\"mask rgba-white-slight\"></div>\n            </a>\n        </div>\n        <!--/Card image-->\n\n        <!-- Card content -->\n        <mdb-card-body cascade=\"true\" class=\"text-center\">\n\n            <!--Title-->\n            <mdb-card-title>\n                <h4>\n                    <strong>Food Express</strong>\n                </h4>\n            </mdb-card-title>\n\n            <h5 class=\"indigo-text\">\n                <strong>Serving IIT Bhubanshwar</strong>\n            </h5>\n\n            <mdb-card-text>\n                Food Express is a mobile food delivery Application, currently operating in IIT Bhubaneshwar.\n            </mdb-card-text>\n        </mdb-card-body>\n    </mdb-card>\n\n    <div class=\"list-group margin-top-200\">\n        <a href=\"#\" class=\"list-group-item list-group-item-action flex-column align-items-start active\">\n            <div class=\"d-flex w-100 justify-content-between\">\n                <h5 class=\"mb-1\">Shops List</h5>\n            </div>\n        </a>\n        <a href=\"#\" class=\"list-group-item list-group-item-action flex-column align-items-start\">\n            <div class=\"d-flex w-100 justify-content-between\">\n                <h5 class=\"mb-1\">Lokenath Juice Shop</h5>\n                <mdb-icon icon=\"heart\" class=\"deep-orange-text\"></mdb-icon>\n            </div>\n            <p class=\"mb-1\">An all purpose restro provides all basic food category.</p>\n            <small class=\"text-muted\"></small>\n        </a>\n    </div>\n\n    <div class=\"login-btn\">\n        <button mdbBtn type=\"button\" gradient=\"purple\" rounded=\"true\" class=\"waves-light\" mdbWavesEffect (click)=\"submitLogin()\">Login</button>\n    </div>\n</div>"
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(router, fb) {
        this.router = router;
        this.fb = fb;
...
module.exports = "<mdb-navbar SideClass=\"navbar navbar-expand-lg navbar-dark indigo sticky-top\">\n    <mdb-navbar-brand>\n        <form class=\"form-inline\">\n\n            <a mdbBtn floating=\"true\" size=\"sm\" gradient=\"peach\" mdbWavesEffect (click)=\"gotoHome()\">\n                <mdb-icon icon=\"home\"></mdb-icon>\n            </a>\n\n            <span class=\"navbar-brand\" href=\"#\">Your Location: MHR</span>\n\n        </form>\n    </mdb-navbar-brand>\n</mdb-navbar>"
...
var SubHeaderComponent = /** @class */ (function () {
    ...
    SubHeaderComponent.prototype.gotoHome = function () {
...
module.exports = __webpack_require__(/*! /Applications/XAMPP/xamppfiles/htdocs/babu-foodexp-MDB/src/main.ts */"./src/main.ts");
